<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterULBAccountLinking.aspx.cs" Inherits="MasterULBAccountLinking" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <ContentTemplate>
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select Division For Scheme Wise Account Mapping
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="ULBAccount_Id" HeaderText="ULBAccount_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ULBAccount_SchemeId" HeaderText="ULBAccount_SchemeId">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ULBAccount_BankId" HeaderText="ULBAccount_BankId">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ULBAccount_Zone_Id" HeaderText="ULBAccount_Zone_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ULBAccount_Circle_Id" HeaderText="ULBAccount_Circle_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ULBAccount_Division_Id" HeaderText="ULBAccount_Division_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField HeaderText="Scheme Name" DataField="Project_Name" />
                                                    <asp:BoundField HeaderText="Bank" DataField="Bank_Name" />
                                                    <asp:BoundField HeaderText="Branch" DataField="ULBAccount_BranchName" />
                                                    <asp:BoundField HeaderText="Branch Address" DataField="ULBAccount_BranchAddress" />
                                                    <asp:BoundField HeaderText="IFSC Code" DataField="ULBAccount_IFSCCode" />
                                                    <asp:BoundField HeaderText="Account No" DataField="ULBAccount_AccountNo" />
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-header">
                                    Associated Account Details and Account Linking
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="Branch Address" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtBranchAddress" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <br />
                                        <asp:Button ID="btnSaveAccount" Text="Save Account Details" OnClick="btnSaveAccount_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                    </div>
                                </div>
