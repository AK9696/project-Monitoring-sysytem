<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterDeduction.aspx.cs" Inherits="MasterDeduction" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Deduction Master</h3>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Deduction Mode" DataField="Deduction_Mode" />
                                                    <asp:BoundField HeaderText="Deduction Category" DataField="Deduction_Category" />
                                                    ...
                                                    <asp:BoundField DataField="Moddified_Date" HeaderText="Modified Date" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label4" runat="server" Text="Deduction Mode" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:DropDownList ID="ddlDeductionMode" runat="server">
                                            <asp:ListItem Text="Addition" Value="+"></asp:ListItem>
                                            <asp:ListItem Text="Substraction" Selected="True" Value="-"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="Deduction Type" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:RadioButtonList ID="rbtStatusType" RepeatDirection="Horizontal" runat="server">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label3" runat="server" Text="Deduction Category" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:DropDownList ID="ddldeductionCategory" runat="server">
                                            <asp:ListItem Selected="True" Text="---Select---" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Statutory Deductions" Value="Statutory Deductions"></asp:ListItem>
                                            <asp:ListItem Text="Other Deductions" Value="Other Deductions"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="lblDeduction" runat="server" Text="Deduction" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtDeduction" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" runat="server" Text="Value" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_Deduction_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
