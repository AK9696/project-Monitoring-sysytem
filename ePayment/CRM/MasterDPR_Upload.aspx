                    ...
                    <div class="page-content">
                        ...
                        <div runat="server" visible="false" id="divEntry">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3">
                                        <label class="control-label no-padding-right">Upload Complete DPR file (PDF)</label>
                                        <iframe id="Iframe2" src="~/CommanFileUpload.aspx?UploadCheck=1&Name=DPR PDF File" runat="server"></iframe>
                                        <asp:HiddenField runat="server" ID="hdnf2Upload" />
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label no-padding-right">Upload Design Document</label>
                                        <iframe id="Iframe4" src="~/CommanFileUpload.aspx?UploadCheck=2&Name=Design Document" runat="server"></iframe>
                                        <asp:HiddenField runat="server" ID="hdnf1Upload" />
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label no-padding-right">Upload Site Phitographs Initial (Pic 1)</label>
                                        <iframe id="Iframe1" src="~/CommanFileUpload.aspx?UploadCheck=3&Name=Site Phitograph (Pic 1)" runat="server"></iframe>
                                        <asp:HiddenField runat="server" ID="hdnf3Upload" />
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label no-padding-right">Upload Site Phitographs Initial (Pic 2)</label>
                                        <iframe id="Iframe3" src="~/CommanFileUpload.aspx?UploadCheck=4&Name=Site Phitograph (Pic 2)" runat="server"></iframe>
                                        <asp:HiddenField runat="server" ID="hdnf4Upload" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
