<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="AdditionalDepartmentPaymentCategory.aspx.cs" Inherits="AdditionalDepartmentPaymentCategory" %>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Additional Department Payment Category Master
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="ADP_Category_Id" HeaderText="ADP_Category_Id">
                                                    ...
                                                    <asp:BoundField DataField="ADP_Category_Name" HeaderText="Category" />
