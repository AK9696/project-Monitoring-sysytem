<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterEMBApprove.aspx.cs" Inherits="MasterEMBApprove" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        ...
                        <div id="divEntry" runat="server" visible="false">
                                                            ...
                                                            <table class="table table-striped table-bordered table-hover">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <tr>
                                                                        <td class="">
                                                                            <asp:Label ID="lblQtyExtraPer" runat="server" CssClass="label label-danger arrowed" Font-Bold="true" Text='<%# Eval("PackageEMB_QtyExtraPer") %>'></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtRABillNo" runat="server" onkeyup="isNumericVal(this);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label5" runat="server" Text="MB Date" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                                <asp:GridView ID="grdExtraItemApprove" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdExtraItemApprove_RowDataBound">
                                                    <Columns>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-4">
                                        <iframe id="frm1" src="/CommanFileUpload.aspx?UploadCheck=1&Name=Attach Document" runat="server"></iframe>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnApproveAll" Text="Approve All EMB" OnClick="btnApproveAll_Click" runat="server" CssClass="btn btn-purple"></asp:Button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnGenerateCombineInvoice" Text="Generate Combine Invoice" OnClick="btnGenerateCombineInvoice_Click" runat="server" CssClass="btn btn-primary"></asp:Button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnUpdate" Text="Approve All & Generate Bill" OnClick="btnUpdate_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
