...
diversion:</label>
                            ...
                            <div runat="server" id="divReleaseInstallment" visible="false">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div style="overflow: auto">
                                                <asp:GridView ID="grdCallProductDtls" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="false" EmptyDataText="No Records Found" ShowFooter="true">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="ULB Share (In Lakhs)">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtULBShare" runat="server" CssClass="form-control" Text='<%# Eval("ProjectWorkGO_ULBShare") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
