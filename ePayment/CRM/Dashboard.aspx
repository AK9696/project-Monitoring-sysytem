                ...
                <ContentTemplate>
                    <div class="page-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label no-padding-right">Circle</label>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-3 pricing-box">
                                <div class="widget-box widget-color-dark">
                                    <div class="widget-header">
                                        <h5 class="widget-title bigger lighter">Total Generated Invoice</h5>
                                    </div>
                                                ...
                                                <li>
                                                    <div class="infobox infobox-blue">
                                                        <div class="infobox-icon">
                                                            <i>
                                                                <img src="assets/images/invoice.png" width="60px" height="60px" />
                                                            </i>
                                                        </div>
                                                        <div class="infobox-data">
                                                            <span class="infobox-data-number" style="margin-left: 15px;">
                                                                <asp:LinkButton ID="lnkTotal" runat="server" OnClick="lnkTotal_Click" Font-Bold="true">0</asp:LinkButton></span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-xs-6 col-sm-3 pricing-box">
                                <div class="widget-box widget-color-orange">
                                    <div class="widget-header">
                                        <h5 class="widget-title bigger lighter"><b>Total Invoice Pending For Action</b></h5>
                                    </div>
                                            ...
                                            <ul class="list-unstyled spaced2">
                                                <li>
                                                    <div class="infobox infobox-blue">
                                                        ...
                                                        <div class="infobox-data">
                                                            <span class="infobox-data-number" style="margin-left: 15px;">
                                                                <asp:LinkButton ID="lnkPending" OnClick="lnkPending_Click" runat="server" Font-Bold="true">0</asp:LinkButton></span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-xs-6 col-sm-3 pricing-box">
                                <div class="widget-box widget-color-blue">
                                    <div class="widget-header">
                                        <h5 class="widget-title bigger lighter">Total Invoice Approved</h5>
                                    </div>
                                            ...
                                            <ul class="list-unstyled spaced2">
                                                <li>
                                                    <div class="infobox infobox-blue">
                                                        ...
                                                        <div class="infobox-data">
                                                            <span class="infobox-data-number" style="margin-left: 15px;">
                                                                <asp:LinkButton ID="lnkApproved" runat="server" OnClick="lnkApproved_Click">0</asp:LinkButton></span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-xs-6 col-sm-3 pricing-box">
                                <div class="widget-box widget-color-green">
                                    <div class="widget-header">
                                        <h5 class="widget-title bigger lighter">Total De-Escelated Invoices (Query Raised)</h5>
                                    </div>
                                            ...
                                            <ul class="list-unstyled spaced2">
                                                <li>
                                                    <div class="infobox infobox-blue">
                                                        ...
                                                        <div class="infobox-data">
                                                            <span class="infobox-data-number" style="margin-left: 15px;">
                                                                <asp:LinkButton ID="lnkDe_Escelated" runat="server" OnClick="lnkDe_Escelated_Click">0</asp:LinkButton></span>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <h3 class="header smaller red">Pending Action(s)
                            ...
                            <asp:CheckBox runat="server" ID="ChkShowEMB" Text="Show EMB Which is Invoice Not Generate." OnCheckedChanged="ChkShowEMB_CheckedChanged" AutoPostBack="true"/>
                                </div>
                        </h3>
                                        ...
                                        <asp:GridView ID="grdEMB" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Records Found" OnPreRender="grdEMB_PreRender" OnRowDataBound="grdEMB_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnOpenEMB" runat="server" Height="20px" ImageUrl="~/assets/images/edit.png" OnClick="btnOpenEMB_Click" Width="20px" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Bulk Action">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkMarkMB" runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <%--<div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <asp:Button ID="btnMarkMB" Text="Mark" OnClick="btnMarkMB_Click" runat="server" CssClass="btn btn-purple" Visible="fa"></asp:Button>

                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Button ID="btnCombineEMB" Text="Combine EMB" OnClick="btnCombineEMB_Click"  runat="server" CssClass="btn btn-primary"></asp:Button>
