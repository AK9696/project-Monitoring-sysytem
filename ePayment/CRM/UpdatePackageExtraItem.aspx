<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="UpdatePackageExtraItem.aspx.cs" Inherits="UpdatePackageExtraItem" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Upload Extra Item
                        ...
                        <div id="divEntry" runat="server" visible="false">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-md-4">
                                        <iframe id="frm1" src="/SpecificExtensionFileUpload.aspx?UploadCheck=1&Name=Upload Exrta Items Excel File" runat="server"></iframe>
                                    </div>
                                    <div class="col-md-4">
                                        <iframe id="frm2" src="/SpecificExtensionFileUpload.aspx?UploadCheck=2&Name=Upload Approval Letter PDF File" runat="server"></iframe>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <br />
                                            &nbsp; &nbsp;
                                        <asp:Button ID="btnUpload" Text="Upload" runat="server" CssClass="btn btn-warning" OnClick="btnUpload_Click"></asp:Button>
                                        </div>
                                    </div>
