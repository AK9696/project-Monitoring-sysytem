<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="TicketDetails.aspx.cs" Inherits="TicketDetails" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label no-padding-right">Till No:</label>
                                       <asp:TextBox ID="txtTillDate" runat="server" CssClass="form-control date-picker" autocomplete="off" data-date-format="dd/mm/yyyy"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender" OnRowDataBound="grdPost_RowDataBound">
                                                <Columns>
                                                    <asp:BoundField DataField="TicketDetails_Id" HeaderText="TicketDetails_Id">
                                                    ...
                                                    <asp:BoundField DataField="TicketDetails_Description" HeaderText="Description" />
                                                    <asp:BoundField DataField="TicketDetails_CloseDescription" HeaderText="Close Description" />
                                                    <asp:BoundField DataField="TicketDetails_TicketStatus" HeaderText="Status" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblTicketCategory" runat="server" Text="Ticket Close Description*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtTicketCloseDescription" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_TicketDetails_Id" runat="server" Value="0" />
                </ContentTemplate>
