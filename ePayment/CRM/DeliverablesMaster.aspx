<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="DeliverablesMaster.aspx.cs" Inherits="DeliverablesMaster" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblUnit" runat="server" Text="Deliverables*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtDeliverables" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <asp:HiddenField ID="hf_Deliverables_Id" runat="server" Value="0" />
