<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterRole.aspx.cs" Inherits="MasterRole" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblRole" runat="server" Text="Role*" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_Role_Id" runat="server" Value="0" />
