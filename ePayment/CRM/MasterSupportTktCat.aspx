<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterSupportTktCat.aspx.cs" Inherits="MasterSupportTktCat" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="TicketCategory_Id" HeaderText="TicketCategory_Id">
                                                    ...
                                                    <asp:BoundField DataField="TicketCategory_Name" HeaderText="Ticket Category" />
                                                    <%-- <asp:TemplateField HeaderText="TicketCategory">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtTicketCategoryG" Enabled="false" runat="server" CssClass="form-control" Text='<%# Eval("TicketCategory_Name") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblTicketCategory" runat="server" Text="Ticket Category*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtTicketCategory" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                    ...
                    <asp:HiddenField ID="hf_TicketCategory_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
