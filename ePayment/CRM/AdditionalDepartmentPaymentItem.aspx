<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="AdditionalDepartmentPaymentItem.aspx.cs" Inherits="AdditionalDepartmentPaymentItem" %>
                ...
                <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Additional Department Payment Item Master
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ADP_Item_Rate" HeaderText="Rate" />
                                                    <asp:BoundField DataField="ADP_Item_Qty" HeaderText="Qty" />
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup1" Style="display: none; width: 800px; margin-left: -32px">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="table-header">
                                    Additional Department Payment Category
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="lblDPR_Status" runat="server" Text="Category*" CssClass="control-label no-padding-right"></asp:Label>
                                         <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                              <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="Unit*" CssClass="control-label no-padding-right"></asp:Label>
                                         <asp:DropDownList ID="ddlUnit" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Rate </label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                  <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Specification* </label>
                                            <asp:TextBox ID="txtSpecification" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                 
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Qty </label>
                    ...
                    <asp:HiddenField ID="hf_ADP_Category_Id" runat="server" Value="0" />
                </ContentTemplate>
            </asp:UpdatePanel>
