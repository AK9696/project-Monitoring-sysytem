<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="SetInspectionMaster.aspx.cs" Inherits="SetInspectionMaster" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                        ...
                        <div id="divCreateNew" runat="server" visible="false">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <asp:Label ID="lblUnit" runat="server" Text="Set Name*" CssClass="control-label no-padding-right"></asp:Label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">M_Level*</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <br />
                                            <asp:Button ID="btnAdd" OnClick="btnAdd_Click" Text="Add" runat="server" CssClass="btn btn-info"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div style="overflow: auto">
                                        <asp:GridView ID="dgvAddDesignation" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkDeleteAdditionalULB" runat="server" OnClick="lnkDeleteAdditionalULB_Click" ImageUrl="~/assets/images/delete.png" Width="20px" Height="20px"></asp:ImageButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    <asp:BoundField DataField="SetInspectionMaster_Id" HeaderText="SetInspectionMaster_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                    ...
                    <asp:HiddenField ID="hf_SetInspectionMaster_Id" runat="server" Value="0" />
