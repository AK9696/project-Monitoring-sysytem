<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="MasterDPR_Verefy.aspx.cs" Inherits="MasterDPR_Verefy" %>
                        ...
                        <div runat="server" visible="false" id="divEntry">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label5" runat="server" Text="Received At HQ" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:TextBox ID="txtReceivingDate" runat="server" CssClass="form-control date-picker" autocomplete="off" data-date-format="dd/mm/yyyy"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label no-padding-right">Status*</label>
                                            <asp:DropDownList ID="ddlDPR_Status" runat="server" CssClass="form-control" ></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <br />
                                            &nbsp; &nbsp;
                                        <asp:Button ID="btnUpload" Text="Verify DPR" OnClick="btnUpload_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                        </div>
                                    </div>
