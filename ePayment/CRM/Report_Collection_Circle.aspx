<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_Collection_Circle.aspx.cs" Inherits="Report_Collection_Circle" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="page-content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h3 class="header smaller lighter blue">Circle Wise - Analysis Report</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Circle Wise Work Execution Report
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost1" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost1_PreRender" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Total_Work" HeaderText="निकाय में चल रहे प्रोजेक्ट की संख्या" />
                                                    <asp:BoundField DataField="ProjectDPR_BudgetAllocated" HeaderText="स्वीकृत धनराशी (लाख में)" />
                                                    <asp:BoundField DataField="Fund_Released" HeaderText="कुल अवमुक्त धनराशी (लाख में)" />
                                                    <asp:BoundField DataField="Expenditure" HeaderText="कुल व्यय (लाख में)" />
                                                    <asp:BoundField DataField="Balance" HeaderText="कुल अवशेष धनराशी (लाख में)" />
                                                </Columns>
