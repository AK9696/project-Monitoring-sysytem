                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label no-padding-right">Designation1*</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <br />
                                        <asp:CheckBox ID="chkAllowInputTransferAmount" runat="server" CssClass="form-control" Text="Allowed For Input Transfer Amount Against Invoices"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
