<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_Package_Wise_Summery.aspx.cs" Inherits="Report_Package_Wise_Summery" MaintainScrollPositionOnPostback="true" %>
                                            ...
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View Details">
                                                        <ItemTemplate>
                                                            <a href="MasterGenerateInvoice_View.aspx?Package_Id=<%# Eval("ProjectWorkPkg_Id") %>&Invoice_Id=0" target="_blank">View Details</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
