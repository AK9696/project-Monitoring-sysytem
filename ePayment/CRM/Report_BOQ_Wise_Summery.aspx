<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="Report_BOQ_Wise_Summery.aspx.cs" Inherits="Report_BOQ_Wise_Summery" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                        ...
                                        <asp:GridView ID="grdBOQ" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdBOQ_PreRender" OnRowDataBound="grdBOQ_RowDataBound" ShowFooter="true">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Specification / BOQ Extra Item">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtSpecification" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_Specification") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtQty" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_Qty") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Estimated Rate">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtRateEstimate" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_RateEstimated") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Estimated Amount">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtAmountEstimate" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_AmountEstimated") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Quoted Rate">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtRateQuoted" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_RateQuoted") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Quoted Amount">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtAmountQuoted" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_AmountQuoted") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Qty Paid Till Date">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtQtyPaid" runat="server" CssClass="control-label no-padding-right" Text='<%# Eval("PackageBOQ_QtyPaid") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
