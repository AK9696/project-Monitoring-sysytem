<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterBOQ.aspx.cs" Inherits="MasterBOQ" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
                                ...
                                <div class="col-xs-12">
                                    <div class="table-header">
                                        ...
                                        <div class="form-group" style="float: right; padding-right: 10px">
                                            <asp:ImageButton ID="lnkImport" runat="server" OnClick="lnkImport_Click" ImageUrl="~/assets/images/excel_import.png" Width="20px" Height="20px"></asp:ImageButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <br />
                                            &nbsp; &nbsp;
                                        <asp:Button ID="btnSaveBOQ" Text="Create BOQ" OnClick="btnSaveBOQ_Click" runat="server" CssClass="btn btn-warning"></asp:Button>
                                        </div>
                                    </div>
