<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PreviousGenerateInvoice.aspx.cs" Inherits="PreviousGenerateInvoice" %>
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-3">
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label3" runat="server" Text="Amount (In Lakhs)" CssClass="control-label no-padding-right"></asp:Label>
                                            <asp:TextBox ID="txtAmount" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <asp:Label ID="Label4" runat="server" Text="Amount Paid To Contractor (In Lakhs)" CssClass="control-label no-padding-right"></asp:Label>
