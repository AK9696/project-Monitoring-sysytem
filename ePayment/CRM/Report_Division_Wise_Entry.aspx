<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="Report_Division_Wise_Entry.aspx.cs" Inherits="Report_Division_Wise_Entry" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Filter Criteria To View Details
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlScheme" runat="server" class="chosen-select form-control" data-placeholder="Choose a Scheme..."></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <br />
                                        <asp:CheckBox ID="chkShowBOQ" Text="Show Only BOQ Uploaded Data" Checked="true" runat="server" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Division Wise Project and Package Status Report
                                        </div>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Updated" HeaderText="Package Updated" />
                                                    <asp:BoundField DataField="Freezed" HeaderText="Package Freezed" />
