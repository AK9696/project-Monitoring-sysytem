<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterUnit.aspx.cs" Inherits="MasterUnit" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                                        ...
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdPost" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPreRender="grdPost_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Unit_Length_Applicable" HeaderText="Length Applicable" />
                                                    <asp:BoundField DataField="Unit_Bredth_Applicable" HeaderText="Bredth Applicable" />
                                                    <asp:BoundField DataField="Unit_Height_Applicable" HeaderText="Height Applicable" />
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="lblUnit" runat="server" Text="Unit*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:TextBox ID="txtUnit" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="Length Applicable?*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:CheckBox ID="chkLengthApplicable" runat="server" CssClass="form-control"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="Label2" runat="server" Text="Bredth Applicable?*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:CheckBox ID="chkBredthApplicable" runat="server" CssClass="form-control"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Label ID="Label3" runat="server" Text="Height Applicable?*" CssClass="control-label no-padding-right"></asp:Label>
                                        <asp:CheckBox ID="chkHeightApplicable" runat="server" CssClass="form-control"></asp:CheckBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <asp:HiddenField ID="hf_Unit_Id" runat="server" Value="0" />
