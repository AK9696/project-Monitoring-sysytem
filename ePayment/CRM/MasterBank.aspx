<%@ Page Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true"
    CodeFile="MasterBank.aspx.cs" Inherits="MasterBank" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="main-content-inner">
            ...
            <asp:UpdatePanel ID="up" runat="server">
                <ContentTemplate>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblBank" runat="server" Text="Bank*" CssClass="control-label no-padding-right"></asp:Label>
                    ...
                    <asp:HiddenField ID="hf_Bank_Id" runat="server" Value="0" />
