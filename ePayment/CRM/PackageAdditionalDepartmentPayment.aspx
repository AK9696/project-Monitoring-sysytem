<%@ Page Title="" Language="C#" MasterPageFile="~/TemplateMasterAdmin.master" AutoEventWireup="true" CodeFile="PackageAdditionalDepartmentPayment.aspx.cs" Inherits="PackageAdditionalDepartmentPayment" %>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Select A Work Package TO Create BOQ
                         ...
                         <div id="divEntry" runat="server" visible="false">
                             <br/>
                              <div class="row">
                                    <div class="col-xs-12">
                                        <div class="table-header">
                                            Add Additional Department Payment Item
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div style="overflow: auto">
                                            <asp:GridView ID="grdADPItems" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EmptyDataText="No Records Found" OnRowDataBound="grdADPItems_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ADP_Item_Id" HeaderText="ADP_Item_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ADP_Item_Category_Id" HeaderText="ADP_Item_Category_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="ADP_Item_Unit_Id" HeaderText="ADP_Item_Unit_Id">
                                                        <HeaderStyle CssClass="displayStyle" />
                                                        <ItemStyle CssClass="displayStyle" />
                                                        <FooterStyle CssClass="displayStyle" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="ADP_Category_Name" HeaderText="Category_Name" />
                                                    <asp:BoundField DataField="ADP_Item_Specification" HeaderText="Specification" />
                                                    <asp:BoundField DataField="Unit_Name" HeaderText="Unit_Name" />
                                                    <asp:TemplateField HeaderText="Rate">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRate" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" Text='<%# Eval("ADP_Item_Rate") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Qty">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtQty" onkeyup="isNumericVal(this);" runat="server" CssClass="form-control" Text='<%# Eval("ADP_Item_Qty") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:GridView ID="grdTaxes" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" ShowHeader="false" OnRowDataBound="grdTaxes_RowDataBound" Width="250px">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Package_ADP_Item_Tax_Package_Id" HeaderText="Package_ADP_Item_Tax_Package_Id">
                                                                        <HeaderStyle CssClass="displayStyle" />
                                                                        <ItemStyle CssClass="displayStyle" />
                                                                        <FooterStyle CssClass="displayStyle" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtTaxesP" runat="server" CssClass="form-control" MaxLength="10" onkeyup="isNumericVal(this);" Text='<%# Eval("Package_ADP_Item_Tax_Value") %>'></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
