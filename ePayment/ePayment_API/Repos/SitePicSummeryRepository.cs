...
{
    public class SitePicSummeryRepository : RepositoryAsyn
    {
        public SitePicSummeryRepository(string connectionString) : base(connectionString) { }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<List<tbl_ProjectUC>> get_SitePic(tbl_Person obj_tbl_Person)
        {
